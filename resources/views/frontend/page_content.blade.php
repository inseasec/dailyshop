              ...
              <div class="aa-product-inner">
                <!-- start prduct navigation -->
                 <ul class="nav nav-tabs aa-products-tab">
                    <!--  @php
                        $category_key = array_keys($department_category);
                      @endphp

                      @for($i = 0; $i < count($department_category); $i++)
                        @foreach($department_category[$category_key[$i]] as $key => $value)
                          <li class=""><a href="#{{$value}}" data-toggle="tab">{{$value}}</a></li>
                        @endforeach
                      @endfor -->
                  ...
                  <div class="tab-content">
                    ...
                    @foreach($products as $product)
                       ...
                       <!--  <li>checking</li> -->
                        <li class="p-10 m-10">
                          <figure>
                            <a class="aa-product-img" href="product/{{$product['id']}}"><img style="height:200px;width: 251px;" src="{{url('images/'.$product['department_id'] .'/' .$product['category_id'] .'/' .$product['name'] .'/' .$product['primary_image'])}}" alt="{{$product['name']}}"></a>
                            <a class="aa-add-card-btn"href="{{url('add-to-cart')}}"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              <figcaption>
                              <h4 class="aa-product-title"><a href="product/{{$product['id']}}">{{$product['name']}}</a></h4>
                              <a href="product/{{$product['id']}}"><span class="aa-product-price"><del>${{$product['price']}}</del></span></a>
                            </figcaption>
                          </figure>                        
